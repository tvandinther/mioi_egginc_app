...
import {AppBar, Slide, SlideProps, Toolbar, Typography, useScrollTrigger} from "@material-ui/core"
...
function HideOnScroll(props: React.PropsWithChildren<SlideProps>) {
...
export default function Navbar(props: React.PropsWithoutRef<JSX.Element>) {
